  ...
  return /* @__PURE__ */ jsxDEV2("header", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxDEV2("div", {
        ...
        children: [
          group ? /* @__PURE__ */ jsxDEV2("span", {
            className: "uppercase",
            children: group
          }, undefined, false, undefined, this) : null,
          group && (resource || total !== undefined) ? /* @__PURE__ */ jsxDEV2("span", {
            "aria-hidden": "true",
            children: "·"
          }, undefined, false, undefined, this) : null,
          resource ? /* @__PURE__ */ jsxDEV2("span", {
          ...
          total !== undefined ? /* @__PURE__ */ jsxDEV2("span", {
            children: [
              total,
              " records"
            ]
    ...
    children: [
      ...
      /* @__PURE__ */ jsxDEV3("div", {
        ...
        children: [
          ...
          pageWindow(page, totalPages).map((p, i) => p === "…" ? /* @__PURE__ */ jsxDEV3("span", {
            className: "text-text-muted px-1",
            children: "…"
          }, `e${i}`, false, undefined, this) : p === page ? /* @__PURE__ */ jsxDEV3("span", {
            className: currentClass,
            children: p
          }, p, false, undefined, this) : /* @__PURE__ */ jsxDEV3("a", {
            className: pageClass,
            "data-qlink": true,
            href: href(params, { page: p }),
            children: p
          }, p, false, undefined, this)),
          page < totalPages ? /* @__PURE__ */ jsxDEV3("a", {
            className: pageClass,
            "data-qlink": true,
            href: href(params, { page: page + 1 }),
            children: "Next →"
...
function Toolbar({ searchable, filterable, sortable, params }) {
  if (!searchable?.length && !filterable?.length && !sortable?.length)
    return null;
  return /* @__PURE__ */ jsxDEV4("form", {
    method: "get",
    action: "",
    className: "flex flex-wrap items-end gap-3 py-4",
    children: [
      searchable && searchable.length > 0 ? /* @__PURE__ */ jsxDEV4("label", {
      ...
      (filterable ?? []).map((field) => /* @__PURE__ */ jsxDEV4("label", {
        className: labelClass,
        children: [
          field,
          /* @__PURE__ */ jsxDEV4("input", {
      ...
      sortable && sortable.length > 0 ? /* @__PURE__ */ jsxDEV4(Fragment, {
        children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxDEV4("select", {
                ...
                children: [
                  ...
                  sortable.map((field) => /* @__PURE__ */ jsxDEV4("option", {
                    value: field,
                    children: field
        ...
        children: [
          ...
          /* @__PURE__ */ jsxDEV5("select", {
            ...
            children: [
              ...
              (field.enumValues ?? []).map((v) => /* @__PURE__ */ jsxDEV5("option", {
                value: v,
                children: v
...
async function Panel(props) {
  ...
  return /* @__PURE__ */ jsxDEV5("div", {
    className: "koran-paper font-koran-body text-foreground min-h-screen",
    children: /* @__PURE__ */ jsxDEV5("div", {
      className: "mx-auto max-w-5xl px-4 pb-10 sm:px-6",
      children: [
        /* @__PURE__ */ jsxDEV5(Masthead, {
          title,
              ...
              children: [
                /* @__PURE__ */ jsxDEV5("div", {
                  ...
                  children: [
                    ...
                    canDelete ? /* @__PURE__ */ jsxDEV5("button", {
                      type: "button",
                    ...
                    canEdit ? /* @__PURE__ */ jsxDEV5("span", {
                      ...
                      children: [
                        /* @__PURE__ */ jsxDEV5("select", {
                          ...
                          children: editFields.map((f) => /* @__PURE__ */ jsxDEV5("option", {
                            value: f.name,
                            children: f.name
                ...
                canCreate ? /* @__PURE__ */ jsxDEV5("button", {
                  type: "button",
            ...
            /* @__PURE__ */ jsxDEV5("dialog", {
              ...
              children: /* @__PURE__ */ jsxDEV5("form", {
                ...
                children: [
                  ...
                  createFields.length > 0 ? createFields.map((f) => /* @__PURE__ */ jsxDEV5(FieldInput, {
                    field: f,
                    required: isRequired(f)
                  }, f.name, false, undefined, this)) : /* @__PURE__ */ jsxDEV5("label", {
            ...
            /* @__PURE__ */ jsxDEV5("dialog", {
              ...
              children: /* @__PURE__ */ jsxDEV5("form", {
                ...
                children: [
                  ...
                  editFields.map((f) => /* @__PURE__ */ jsxDEV5(FieldInput, {
                    field: f
                  }, f.name, false, undefined, this)),
                  /* @__PURE__ */ jsxDEV5("p", {
                    "data-form-error": true,
