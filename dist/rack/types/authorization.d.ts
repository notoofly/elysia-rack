export type CrudOperation = "list" | "detail" | "create" | "replace" | "update" | "delete";
export type CrudAuthorizationRule = boolean | string | ((context: CrudAuthorizationContext) => boolean | Promise<boolean>);
